...
#define ENC28J60_SPI_SCK		PB7
#define ENC28J60_SPI_MOSI		PB5
#define ENC28J60_SPI_MISO		PB6
#define ENC28J60_SPI_SS			PB4
...
#define ENC28J60_INT     		PD3

#define ENC28J60_WOL_DDR		DDRD
#define ENC28J60_WOL_PORT		PORTD
#define ENC28J60_WOL     		PD2
...
void enc28j60PacketSend(unsigned int len, uint8_t* packet);
unsigned int enc28j60PacketReceive(unsigned int maxlen, uint8_t* packet);
